...
def amplitude_to_freq_fit(x, m, L1, L2, C1, Cs, R1, R2, const):
    ...
    # m, L1, L2, C1, Cs, R1, R2, const = [0.33 * 10 ** (-3), 0.65 * 10 ** (-3), 1.8 * 10 ** (-3),
    #               35.05 * 10 ** (-11), 10.71 * 10 ** (-11),
    #               60.18, 75.38, 0.01]
...
starting_point = [0.33 * 10 ** (-3), 0.65 * 10 ** (-3), 1.8 * 10 ** (-3),
                  35.05 * 10 ** (-11), 10.71 * 10 ** (-11),
                  60.18, 75.38, 0.01]
